...
const nuevaString = "manuel romero";
...
// 7  No cambies los nombres de las funciones.
...
function resta(x, y) {
  // 9 Resta "y" de "x" y devuelve el valor
  // Tu código:
  return x - y
...
function multiplica(x, y) {
  // 10 Multiplica "x" por "y" y devuelve el valor
  // Tu código:
  return x * y
}

function divide(x, y) {
  // 11 Divide "x" entre "y" y devuelve el valor
  // Tu código:
  return x / y
}

function sonIguales(x, y) {
  // 12 Devuelve "true" si "x" e "y" son iguales
...
function tienenMismaLongitud(str1, str2) {
  // 13  Devuelve "true" si las dos strings tienen la misma longitud
  // De lo contrario, devuelve "false"
  // Tu código:
...
function menosQueNoventa(num) {
  // 14  Devuelve "true" si el argumento de la función "num" es menor que noventa
  // De lo contrario, devuelve "false"
  // Tu código:
    if (num<90) {
      return true
...
function esPar(num) {
  // 17 Devuelve "true" si "num" es par
  // De lo contrario, devuelve "false"
  // Tu código:
  //return num % 2 == 0
...
function esImpar(num) {
  // 18  Devuelve "true" si "num" es impar
  // De lo contrario, devuelve "false"
  // Tu código:
  if (num % 2==1) {
    return true
...
function esPositivo(numero) {
  // 25 La función va a recibir un entero. Devuelve como resultado una cadena de texto que indica si el número es positivo o negativo. 
...
function esVocal(letra){
  //33 Escribe una función que reciba una letra y, si es una vocal, muestre el mensaje “Es vocal”. 
